...
public class FoodList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = MainActivity2.sqLiteHelper.getData("SELECT * FROM FOOD");
        list.clear();
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = MainActivity2.sqLiteHelper.getData("SELECT id FROM FOOD");
            ...
            public void onClick(View v) {
                try {
                    MainActivity2.sqLiteHelper.updateData(
                            ...
                            MainActivity2.imageViewToByte(imageViewFood),
                            position
                    );
                    dialog.dismiss();
    ...
    private void showDialogDelete(final int idFood){
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    MainActivity2.sqLiteHelper.deleteData(idFood);
